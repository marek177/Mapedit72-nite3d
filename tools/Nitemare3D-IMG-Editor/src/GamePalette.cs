    ...
    public void Load(string path)
    {
        ...
        if (data.Length < 768)
            throw new InvalidDataException(
                "Palette file must contain at least 768 RGB bytes.");

        // Known Nitemare 3D DOS GAME.PAL layout is 1924 bytes with the
        // 256xRGB palette starting at decimal offset 1156.
